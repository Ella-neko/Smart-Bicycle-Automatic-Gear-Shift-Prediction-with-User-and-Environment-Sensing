                ...
                while(True):
                    ...
                    if Splitted_GPS_Data[0]=="b'$GNGGA":
                        ...
                        if Splitted_GPS_Data[2]=="":
                            ...
                            writer.writerow([time_data,str(lati)[0:8],str(lang)[0:9]])
                            print(time_data)
                            '''
                            ...
                            #sensor_clock=['']
                            break
                    elif Splitted_GPS_Data[0]=="b'$GNVTG":
                        print("bbb3\n")
                        if Splitted_GPS_Data[7]=="":
                            a=0
                            print("bbb\n")
                        else:
                            '''
                            ...
                            lati=0
                            lang=0
                            print("speed:"+Splitted_GPS_Data[7])
                            speed=Splitted_GPS_Data[7]
                            
                                                
                            sensor.append(str(speed))
                            ...
                            writer.writerow([time_data,str(speed)])
                            print(time_data)
                            '''
                            upLoad2Server(upload_data,client)
                            #print("ccc")
